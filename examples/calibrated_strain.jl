...
m_mirror = 39.6/2                            # kg
Ω_mech   = 2π * 5e-6                         # rad/s — physical pendulum (~1 Hz) (we do not support free mass for now)
...
# ============================================================================
# Coupling constants — inlined (previously g0_coupling / g_coupling from
